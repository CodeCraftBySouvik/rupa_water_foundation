<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4"
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0" href="{{ route('zone.index') }}" target="_blank">
            <img src="{{asset('assets/images/pyaau-logo.png')}}" class="navbar-brand-img h-100" alt="main_logo">
    ...
    <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3 d-flex align-items-center">
                ...
                <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 mb-0">Technician Management</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'zone.employee.index' ? 'active' : '' }}"
                    ...
                    <span class="nav-link-text ms-1">Technician List</span>
                </a>
            </li>
            {{-- Zone Management --}}
            <li class="nav-item mt-3 d-flex align-items-center">
