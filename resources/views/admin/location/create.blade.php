...
@section('content')
{{-- @include('layouts.navbars.auth.topnav', ['title' => 'Create Location']) --}}
                ...
                <form role="form" method="POST" action="{{route('location.store')}}">
                    ...
                    <div class="card-header pb-0">
                        <div class="d-flex align-items-center">
                            <p class="mb-0">Create Location</p>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="location_id"
                                        placeholder="Enter Location Id" value="{{ old('location_id') }}">
                                    @error('location_id')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="location_type" class="form-control">
                                        <option value="" disabled {{ old('location_type', $location->location_type ??
                                            '') == '' ? 'selected' : '' }}>
                                            -- Select --
                                        </option>

                                        <option value="roadside" {{ old('location_type', $location->location_type ?? '')
                                            == 'roadside' ? 'selected' : '' }}>
                                            Roadside
                                        </option>

                                        <option value="complex" {{ old('location_type', $location->location_type ?? '')
                                            == 'complex' ? 'selected' : '' }}>
                                            Complex
                                        </option>
                                    </select>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="position" class="form-control">
                                        <option value="" disabled {{ old('position')===null ? 'selected' : '' }}>
                                            -- Select --
                                        </option>

                                        <option value="small" {{ old('position')=='small' ? 'selected' : '' }}>
                                            Small
                                        </option>

                                        <option value="big" {{ old('position')=='big' ? 'selected' : '' }}>
                                            Big
                                        </option>
                                    </select>
                                    @error('position')
